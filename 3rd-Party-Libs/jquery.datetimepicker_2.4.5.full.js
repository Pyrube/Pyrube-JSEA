 ...
 */
/**
 * Move i18n options out of default_options, make it global static.
 * Modified by Aranjuez on Apr 17th, 2022
 */
...
;(function (factory) {
	...
	$.datetimepicker = {
		setLocale: function(locale){
			globalLocale = GLOBAL_OPTIONS.i18n[locale]?locale:globalLocaleDefault;
			// Override Parse and Format Library entities
			Date.monthNames = GLOBAL_OPTIONS.i18n[globalLocale].months;
			Date.dayNames = GLOBAL_OPTIONS.i18n[globalLocale].dayOfWeek;
		}
	};
	...
	$.fn.datetimepicker = function (opt) {
		...
		createDateTimePicker = function (input) {
			...
			datetimepicker
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						for (j = 0; j < 7; j += 1) {
							// Pyrube-I18N with options.i18n instead of GLOBAL_OPTIONS.i18n, July 5 2023
			...
			timerclick = 0;
			calendar
				.on('click.xdsoft touchend.xdsoft', 'td', function (xdevent) {
			...
			timebox
				.on('click.xdsoft touchend.xdsoft', 'div', function (xdevent) {
